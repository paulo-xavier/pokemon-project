...
//Get element by id pega elemento por id


//- passo 2 - dar um jeito de pegar no JS o elemento HTML corresponde ao body

const body = document.querySelector("body"); //Query selector pega elemento por tag
...
botaoAlterarTema.addEventListener("click", () => {
    ...
    */
    ...
    // body.class.List.toggle("modo-escuro")
    if (modoEscuroEstaAtivo) {
        //passo 7 - remover a classe do modo-escuro do body

        body.classList.remove("modo-escuro");// se usar toggle remove essa linha
        ...
        body.classList.add("modo-escuro"); //se usar o toggle remove essa linha

        //passo 5 - trocar a imagem do botão de alterar tema pra lua
        imagemBotaoTrocaDeTema.setAttribute("src", "./src/imagens/moon.png")
        //                         qual atributo queremos mudar / local onde ele está
        //set atribute usamos quando ja temos algo atribuido ao elemento
    }
